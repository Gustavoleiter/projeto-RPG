...
namespace RpgApi.Data
{
    public class DataContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            (
                new Personagem() { Id = 1, Nome = "Frodo", PontosVida = 100 },
                new Personagem() { Id = 2, Nome = "Sam", PontosVida = 100, Forca = 15, Defesa = 25, Inteligencia = 30, Classe = ClasseEnum.Cavaleiro },
                new Personagem() { Id = 3, Nome = "Galadriel", PontosVida = 100, Forca = 18, Defesa = 21, Inteligencia = 35, Classe = ClasseEnum.Clerigo },
                new Personagem() { Id = 4, Nome = "Gandalf", PontosVida = 100, Forca = 18, Defesa = 18, Inteligencia = 37, Classe = ClasseEnum.Mago },
                new Personagem() { Id = 5, Nome = "Hobbit", PontosVida = 100, Forca = 20, Defesa = 17, Inteligencia = 31, Classe = ClasseEnum.Cavaleiro },
                new Personagem() { Id = 6, Nome = "Gustaf", PontosVida = 100, Forca = 21, Defesa = 13, Inteligencia = 34, Classe = ClasseEnum.Clerigo },
                new Personagem() { Id = 7, Nome = "Radagast", PontosVida = 100, Forca = 25, Defesa = 11, Inteligencia = 35, Classe = ClasseEnum.Mago }
            );
        
            modelBuilder.Entity<Arma>().HasData
            (
                new Arma() { Id = 1, Nome = "Excalibur", Dano = 100000, PersonagemId = 6},
                new Arma() { Id = 2, Nome = "Zanpakto", Dano = 10000 ,PersonagemId = 1},
                new Arma() { Id = 3, Nome = "Rifle", Dano = 1000 ,PersonagemId = 2},
                new Arma() { Id = 4, Nome = "Cutelo", Dano = 250 ,PersonagemId = 5},
                new Arma() { Id = 5, Nome = "Glock", Dano = 500 ,PersonagemId = 7},
                new Arma() { Id = 6, Nome = "Cajado", Dano =  50 ,PersonagemId = 3},
                new Arma() { Id = 7, Nome = "Esmaga-Tama", Dano = 150 ,PersonagemId = 4}
            );
            ...
            (
                ...
                new Habilidade(){Id=4, Nome="Olhar da penitencia", Dano=2537},
                new Habilidade(){Id=5, Nome="Exorcizar", Dano=3799}
            );
            ...
            (                  
                ...
                new PersonagemHabilidade() { PersonagemId = 6, HabilidadeId =4 }, 
